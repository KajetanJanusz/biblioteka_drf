...
def get_five_book_articles():
    urls = ["https://zacofany-w-lekturze.pl", "https://lubimyczytac.pl/aktualnosci"]
            ...
            try:
                ...
                if "lubimyczytac" in url:
                    ...
                    articles = soup.find_all(
                        "a", class_="authorAllBooks__singleTextTitle"
                    )
                    for article in articles[:3]:
                        try:
                            ...
                            description = article.find_next(
                                "p", class_="around-book__text"
                            )
                            description_text = (
                                description.get_text(strip=True) if description else ""
                            )
                            description_text = description_text.split("Czytaj więcej")[
                                0
                            ].strip()
                            ...
                            print(
                                f"Błąd przy przetwarzaniu artykułu z lubimyczytac.pl: {e}"
                            )
                    ...
                    for article in articles[:2]:
                        try:
                            ...
                            if content_div:
                                ...
                                description_text = (
                                    paragraphs[2].get_text(strip=True)
                                    if description_text == ""
                            ...
                            print(
                                f"Błąd przy przetwarzaniu artykułu z zacofany-w-lekturze.pl: {e}"
                            )
