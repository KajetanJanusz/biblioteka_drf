...
from core.ai import generate_and_save_image
...
class BookRental(models.Model):
    book_copy = models.ForeignKey(
        BookCopy, related_name="rentals", on_delete=models.CASCADE
    )
    user = models.ForeignKey(
        CustomUser, related_name="rentals", on_delete=models.CASCADE
    )
